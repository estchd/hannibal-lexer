...
impl LexerMeta {
    ...
    pub fn add_state(&mut self, name: String, state: LexerState) {
        self.state_to_name.insert(state, name.clone());
        self.name_to_state.insert(name, state);
    }

    pub fn add_class(&mut self, name: String, class: ClassificationClass) {
        self.class_to_name.insert(class, name.clone());
        self.name_to_class.insert(name, class);
    }

    pub fn add_type(&mut self, name: String, token_type: TokenType) {
        self.type_to_name.insert(token_type, name.clone());
